    ...
    <div className="relative">
      ...
      {nav ? (
        <div className="fixed w-full h-screen bg-black/70 flex flex-col justify-center items-center z-20">
          <NavigationItem onClick={handleNav} href="#main">
      ...
      <div className="md:block hidden fixed top-[25%] z-10">
        <div className="flex flex-col">
          <a
            href="#main"
            className="text-white rounded-full shadow-lg bg-green-800 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-300"
          >
            <AiOutlineHome size={20} />
          </a>
          <a
